...
int main() {
    ...
    hittable* Surface1 = new surface(glm::vec3(image_width/2 - 120, image_height/2, 0), glm::vec3(1,0, 0), glm::vec4(0.5), simple_light);
    hittable* Surface2 = new surface(glm::vec3(image_width/2 + 120, image_height/2, 0), glm::vec3(-1,0, 0), glm::vec4(0.5), simple_light);
    hittable* Surface3 = new surface(glm::vec3(image_width/2, image_height/2, -20), glm::vec3(0, 0, 1), glm::vec4(0.5), simple_light);
